...
const laundryCategories: LaundryCategory[] = [
  {
    ...
    items: [
      { id: 'suit', name: 'Suit (2 Piece)', price: 15.99, unit: '/item' },
      { id: 'dress-simple', name: 'Dress (Simple)', price: 10.99, unit: '/item' },
      { id: 'dress-formal', name: 'Dress (Formal/Evening)', price: 18.99, unit: '/item' },
      { id: 'coat-light', name: 'Light Jacket/Blazer', price: 9.99, unit: '/item' },
      { id: 'coat-winter', name: 'Winter Coat', price: 16.99, unit: '/item' },
      { id: 'shirt', name: 'Shirt/Blouse', price: 6.99, unit: '/item' },
      { id: 'trousers', name: 'Trousers/Slacks', price: 7.99, unit: '/item' },
      { id: 'skirt', name: 'Skirt (Simple)', price: 7.99, unit: '/item' },
      { id: 'skirt-pleated', name: 'Skirt (Pleated)', price: 9.99, unit: '/item' },
      { id: 'tie', name: 'Tie/Scarf', price: 4.99, unit: '/item' },
      { id: 'sweater', name: 'Sweater/Jumper', price: 7.99, unit: '/item' },
    ]
  },
  {
    id: 'ironed-laundry',
    ...
    items: [
      { id: 'shirt-ironed', name: 'Shirt/Blouse', price: 3.99, unit: '/item' },
      { id: 'trousers-ironed', name: 'Trousers/Slacks', price: 4.99, unit: '/item' },
      { id: 'tshirt-ironed', name: 'T-Shirt', price: 3.49, unit: '/item' },
      { id: 'jeans-ironed', name: 'Jeans', price: 4.99, unit: '/item' },
      { id: 'dress-shirt', name: 'Dress Shirt', price: 4.99, unit: '/item' },
      { id: 'bedsheet-single', name: 'Bed Sheet (Single)', price: 5.99, unit: '/item' },
      { id: 'bedsheet-double', name: 'Bed Sheet (Double/Queen)', price: 6.99, unit: '/item' },
      { id: 'bedsheet-king', name: 'Bed Sheet (King)', price: 7.99, unit: '/item' },
      { id: 'pillowcase', name: 'Pillowcase', price: 1.99, unit: '/item' },
      { id: 'tablecloth-s', name: 'Tablecloth (Small)', price: 6.99, unit: '/item' },
      { id: 'tablecloth-l', name: 'Tablecloth (Large)', price: 9.99, unit: '/item' },
    ]
  },
  {
    id: 'wash-fold',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'blanket-l', name: 'Blanket (Large)', price: 16.99, unit: '/item' },
    ]
  },
  {
    id: 'specialty',
    ...
    items: [
      { id: 'wedding-dress', name: 'Wedding Dress', price: 99.99, unit: '/item' },
      { id: 'formal-gown', name: 'Formal Gown', price: 49.99, unit: '/item' },
      { id: 'leather-jacket', name: 'Leather Jacket', price: 39.99, unit: '/item' },
      { id: 'suede-item', name: 'Suede Item', price: 34.99, unit: '/item' },
      { id: 'stuffed-toy-s', name: 'Stuffed Toy (Small)', price: 7.99, unit: '/item' },
      { id: 'stuffed-toy-l', name: 'Stuffed Toy (Large)', price: 12.99, unit: '/item' },
      { id: 'bag-cleaning', name: 'Bag/Purse Cleaning', price: 24.99, unit: '/item' },
      { id: 'hat-cleaning', name: 'Hat Cleaning', price: 14.99, unit: '/item' },
    ]
  }
];
